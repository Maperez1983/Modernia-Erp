...
- **Sólo el camino principal de dos módulos.** Quedan sin simular gestoría, seguros,
  financiaciones y RRHH, y dentro de fincas e inmobiliaria quedan los caminos que se
  salen de lo normal: derramas, regularizaciones, cambio de propietario a mitad de
  ejercicio, anulaciones, devoluciones parciales, alquileres.
