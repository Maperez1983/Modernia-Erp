...
class FrontendSmokeTests(unittest.TestCase):
    ...
    def test_workspace_copilot_includes_process_supervisor_feed(self):
        ...
        self.assertIn("bootPersistentInternalCopilotShell", app_js)
        ...
        self.assertIn("Portal público", app_js)
        ...
        self.assertIn("current_url", app_js)
        self.assertIn("ui_error_title", app_js)
        self.assertIn("ui_error_history", app_js)
        self.assertIn("window.__CRM_LAST_UI_ERROR", app_js)
