...
class HipotecasDeleteTests(unittest.TestCase):
    ...
    def test_derive_hipoteca_commissions_applies_bonus_office(self):
        ...
        split_verifika = derive_hipoteca_commissions(100.0, "Verifika2 Norte")
        self.assertEqual(split_verifika["comision_juan"], 20.0)
        self.assertEqual(split_verifika["cesion"], 25.0)
        self.assertEqual(split_verifika["comision_modernia"], 55.0)
